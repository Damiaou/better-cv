...
export function Wall() {
  return (
    <div className="relative good-wall w-5/6 bg-gradient-to-tr from-yellow-200 to-red-200 h-5/6 grid grid-cols-3 pb-5 pt-20 m-4">
      <div
        className="surfboard self-end static place-self-center h-full"
        title="Surf"
        alt="Surf"
      >
        {/* <!--       surfboard --> */}
      ...
      <div
        className="w-full h-full grid grid-cols-2 grid-rows-8 static justify-items-center"
        title="Climbing"
        alt="Climbing"
      >
        {/* <!--       climbing holds --> */}
      ...
      <div
        className=" self-end w-full flex justify-center"
        alt="Reading"
        title="Reading"
      >
        <div className="w-5/6 ">
